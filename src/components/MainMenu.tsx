...
export function MainMenu({ hasSave, notice, onContinue, onLocalMode, onOnlineMode, onReplayStudy, onSettings, testModeEnabled = false, onTestMode = () => undefined }: MainMenuProps) {
  return (
